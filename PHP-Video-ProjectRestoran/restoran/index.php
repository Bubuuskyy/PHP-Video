...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            if (isset($_SESSION['pelanggan'])) {
                echo '<div class="float-end mt-3 me-3"><a href="?log=logout">Logout</a></div>
                ...
                echo '<div class="float-end mt-3"><a href="?f=home&m=login">Login</a></div>
    ...
    <div class="row mt-5">
        <div class="col">
            <p class="text-center">2022 - copyright@amalikramdhani</p>
        </div>
    </div>
