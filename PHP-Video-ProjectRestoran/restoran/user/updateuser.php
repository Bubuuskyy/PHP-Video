...
<div>
    <form action="" method="post" class="form-group">
        <div class="form=group w-50 mt-1">
            ...
            <input type="text" name="user" required value="<?php echo $row['user']?>"class="form-control mt-1">
        </div>
        <div class="form=group w-50 mt-4">
            <label for="">Email</label>
            <input type="email" name="email" required value="<?php echo $row['email']?>" class="form-control mt-1">
        </div>
        <div class="form=group w-50 mt-4">
            <label for="">Password</label>
            <input type="password" name="password" required value="<?php echo $row['password']?>" class="form-control mt-1">
        </div>
        <div class="form=group w-50 mt-4">
            <label for="">Konfirmasi Password</label>
            <input type="password" name="konfirmasi" required value="<?php echo $row['password']?>" class="form-control mt-1">
        </div>
